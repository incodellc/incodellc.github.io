...
export default function ContentLayout() {
  ...
  return (
    <div className="pt-0 lg:pt-20 px-4 pb-10 flex container mx-auto flex-col lg:flex-row lg:px-8 lg:gap-20 xl:gap-32 2xl:gap-40">
      <div className="basis-auto shrink-0 lg:basis-80 xl:basis-[400px]">
        <div className="element-with-custom-scroll top-0 overflow-auto static w-full lg:h-screen lg:fixed lg:pt-20 lg:w-80 xl:w-[400px]">
